      ...
      <div className={styles.delete_modal} onClick={(e) => e.stopPropagation()}>
        ...
        <div className={styles.delete_middle}>
            <div className={styles.delete_icon}>
                <svg viewBox="0 0 24 24" fill="none" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><polyline points="3 6 5 6 21 6"></polyline><path d="M19 6l-1 14H6L5 6"></path><path d="M10 11v6M14 11v6"></path><path d="M9 6V4h6v2"></path></svg>
            </div>
            <div className={styles.delete_title}>Are you sure</div>
            <div>
                <p>This will remove <span>"{id.district}"</span> from the list</p>
            </div>
        </div>
